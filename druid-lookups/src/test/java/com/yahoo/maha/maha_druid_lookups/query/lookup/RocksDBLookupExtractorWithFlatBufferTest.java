...
public class RocksDBLookupExtractorWithFlatBufferTest {
    ...
    public void testBuildWhenDimensionValueIsEmpty()  throws Exception {
        ...
        , "com.yahoo.maha.maha_druid_lookups.server.lookup.namespace.entity.CacheActionRunnerFlatBuffer", null, false, false, 0, null);
    ...
    public void testBuildWhenInvalidValueColumn() throws Exception {
        ...
        try {
            ...
            RocksDBExtractionNamespace extractionNamespace =
                new RocksDBExtractionNamespace("ad_lookup", "blah", "blah", new Period(), "", true, false, "ad_lookup", "last_updated", null, "com.yahoo.maha.maha_druid_lookups.server.lookup.namespace.entity.CacheActionRunnerFlatBuffer", null, false, false, 0, null);
