...
class RegistryTest extends FunSuite with Matchers {
  ...
  test("getCubeJsonForName should be able to return the correct json for given cube name") {
    ...
    registryBuilder.register(base_dim)
    val registry = registryBuilder.build()
    println(registry.getCubeJsonAsStringForCube("publicFact"))
  ...
  test("flatten domainJsonAsString should return all possible fields in cube") {
    ...
    registryBuilder.register(base_dim_with_revision)
    val registry = registryBuilder.build()
    println(registry.getFlattenCubeJsonAsStringForCube(pubfact.name))
    println(registry.flattenDomainJsonAsString)
  ...
  test("flatten domainJsonAsString should return correct version of cube") {
    ...
    registryBuilder.register(base_dim_with_revision)
    val registry = registryBuilder.build()
    println(registry.getFlattenCubeJsonAsStringForCube(pubfact.name, 1))
    println(registry.flattenDomainJsonAsString)
    val expected = s"""{"name":"publicFact","mainEntityIds":{"advertiser":"Advertiser ID"},"maxDaysLookBack":[{"requestType":"SyncRequest","grain":"DailyGrain","days":30},{"requestType":"AsyncRequest","grain":"DailyGrain","days":30}],"maxDaysWindow":[{"requestType":"SyncRequest","grain":"DailyGrain","days":20},{"requestType":"AsyncRequest","grain":"DailyGrain","days":20},{"requestType":"SyncRequest","grain":"HourlyGrain","days":20},{"requestType":"AsyncRequest","grain":"HourlyGrain","days":20}],"fields":[{"field":"Advertiser ID","type":"Dimension","dataType":{"type":"Number","constraint":null},"dimensionName":"advertiser","filterable":true,"filterOperations":["="],"required":false,"filteringRequired":false},{"field":"Destination URL","type":"Dimension","dataType":{"type":"String","constraint":null},"dimensionName":null,"filterable":false,"filterOperations":null,"required":false,"filteringRequired":false},{"field":"Fact ID","type":"Dimension","dataType":{"type":"Number","constraint":null},"dimensionName":null,"filterable":true,"filterOperations":["="],"required":false,"filteringRequired":false},{"field":"Is Adjustment","type":"Dimension","dataType":{"type":"Enum","constraint":"Y|N"},"dimensionName":null,"filterable":true,"filterOperations":["="],"required":false,"filteringRequired":false},{"field":"Pricing Type","type":"Dimension","dataType":{"type":"Enum","constraint":"CPCV|CPC|CPF|CPM|CPE|CPV|CPA"},"dimensionName":null,"filterable":true,"filterOperations":["IN"],"required":false,"filteringRequired":false},{"field":"Source","type":"Dimension","dataType":{"type":"Number","constraint":"3"},"dimensionName":null,"filterable":true,"filterOperations":["="],"required":false,"filteringRequired":false},{"field":"Clicks","type":"Fact","dataType":{"type":"Number","constraint":null},"dimensionName":null,"filterable":true,"filterOperations":["IN"],"required":false,"filteringRequired":false,"rollupExpression":"SumRollup"},{"field":"Impressions","type":"Fact","dataType":{"type":"Number","constraint":null},"dimensionName":null,"filterable":true,"filterOperations":["IN","="],"required":false,"filteringRequired":false,"rollupExpression":"SumRollup"},{"field":"Advertiser Status","type":"Dimension","dataType":{"type":"String","constraint":null},"dimensionName":"advertiser","filterable":true,"filterOperations":["="],"required":false,"filteringRequired":false},{"field":"Ad Asset JSON","type":"Dimension","dataType":{"type":"String","constraint":null},"dimensionName":"advertiser","filterable":true,"filterOperations":["IN","="],"required":false,"filteringRequired":false}]}"""
