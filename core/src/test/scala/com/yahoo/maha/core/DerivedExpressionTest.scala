    ...
    ColumnContext.withColumnContext {
      implicit cc: ColumnContext =>
        ...
        val allExpectedStrings: List[String] = List(
          """{"DerivedFunctionColumn":{"DimensionColumn":{"name":"date_id","alias":null,"dataType":{"DateType":{"jsonDataType":"Date","constraint":"yyyyMMdd","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"format":"yyyyMMdd"},"annotations":"Set()","filterOperationOverrides":"Set()","columnContext":"1052195003"},"isForeignKey":false},"derivedFunction":{"function_type":"DATETIME_FORMATTER","fieldName":"{date}","index":0,"length":3}}"""
          ,"""{"PostResultColumn":{"DimensionColumn":{"name":"pr_col","alias":null,"dataType":{"IntType":{"jsonDataType":"Number","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"length":0,"staticMapping":null,"default":-1,"min":-1,"max":-1},"annotations":"Set()","filterOperationOverrides":"Set()","columnContext":"1052195003"},"isForeignKey":false},"postResultFunction":{"postResultFunction":"START_OF_THE_WEEK","expression":"{date_id}"}}"""
          ,"""{"DimCol":{"DimensionColumn":{"name":"blue_id","alias":null,"dataType":{"StrType":{"jsonDataType":"String","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"length":0,"staticMapping":null,"default":""},"annotations":"Set()","filterOperationOverrides":"Set()","columnContext":"1052195003"},"isForeignKey":false},"name":"blue_id","dataType":{"StrType":{"jsonDataType":"String","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"length":0,"staticMapping":null,"default":""},"aliasOrName":"blue_id","annotations":"Set()","filterOperationOverrides":"Set()"}"""
          ,"""{"DimCol":{"DimensionColumn":{"name":"pt_col","alias":null,"dataType":{"PassthroughType":{"jsonDataType":"Null","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"format":"None"},"annotations":"Set()","filterOperationOverrides":"Set()","columnContext":"1052195003"},"isForeignKey":false},"name":"pt_col","dataType":{"PassthroughType":{"jsonDataType":"Null","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"format":"None"},"aliasOrName":"pt_col","annotations":"Set()","filterOperationOverrides":"Set()"}"""
          ,"""{"DimCol":{"DimensionColumn":{"name":"ts_id","alias":null,"dataType":{"TimestampType":{"jsonDataType":"Date","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"format":"None"},"annotations":"Set()","filterOperationOverrides":"Set()","columnContext":"1052195003"},"isForeignKey":false},"name":"ts_id","dataType":{"TimestampType":{"jsonDataType":"Date","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"format":"None"},"aliasOrName":"ts_id","annotations":"Set()","filterOperationOverrides":"Set()"}"""
          ,"""{"FactCol":{"FactColumn":{"name":"new_id","alias":null,"dataType":{"IntType":{"jsonDataType":"Number","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"length":0,"staticMapping":null,"default":-1,"min":-1,"max":-1},"annotations":"Set()","filterOperationOverrides":"Set()","columnContext":"1052195003"},"hasRollupWithEngineRequirement":true},"name":"new_id","dataType":{"IntType":{"jsonDataType":"Number","constraint":"None","hasStaticMapping":false,"hasUniqueStaticMapping":false,"reverseStaticMapping":"Map()"},"length":0,"staticMapping":null,"default":-1,"min":-1,"max":-1},"rollupExpression":{"expressionName":"DruidCustomRollup","hasDerivedExpression":true,"sourcePrimitiveColumns":"Set(impressions, account_id, clicks)"},"aliasOrName":"new_id","annotations":"Set()","filterOperationOverrides":"Set()"}"""
          ,"""{"DerivedColumn":{"FactColumn":{"name":"self_call","alias":null,"dataType":{"IntType":{"jsonDataType":"Enum","constraint":"2","hasStaticMapping":true,"hasUniqueStaticMapping":true,"reverseStaticMapping":"Map(2 -> Set(1))"},"length":3,"staticMapping":{"tToStringMap":"1 -> 2","default":"1"},"default":-1,"min":-1,"max":-1},"annotations":"Set()","filterOperationOverrides":"Set()","columnContext":"1052195003"},"hasRollupWithEngineRequirement":false},"derivedExpression":{"expression":{"expression":"Arithmetic","hasNumericOperation":true,"hasRollupExpression":false},"sourcePrimitiveColumns":"Set(impressions, account_id, clicks)"}}"""
        )
        ...
        val allCompactJSONs: Set[String] = allJSONs.map(col => compact(col))
        //assert(allExpectedStrings.forall(json => allCompactJSONs.contains(json)))
        println(allCompactJSONs.mkString("\n,"))
    }
  }
}
