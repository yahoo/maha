...
object RequestModel extends Logging {
  ...
  def renderStaticMappedEqualityFilter(filter: EqualityFilter
  ...
  def renderStaticMappedInFilter(filter: InFilter
  ...
  def renderStaticMappedNotInFilter(filter: NotInFilter
