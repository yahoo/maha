...
class CombinedFuture6<T, U, V, W, X, Y> extends AbstractFuture<Either<GeneralError, Tuple6<T, U, V, W, X, Y>>> {
        ...
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, T, Tuple6<T, U, V, W, X, Y>>castLeft(returnValue));
                }
            } else {
    ...
    private void setSecondValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, U, Tuple6<T, U, V, W, X, Y>>castLeft(returnValue));
                }
            } else {
    ...
    private void setThirdValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, V, Tuple6<T, U, V, W, X, Y>>castLeft(returnValue));
                }
            } else {
    ...
    private void setFourthValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, W, Tuple6<T, U, V, W, X, Y>>castLeft(returnValue));
                }
            } else {
    ...
    private void setFifthValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, X, Tuple6<T, U, V, W, X, Y>>castLeft(returnValue));
                }
            } else {
                fifthValue = returnValue.right().get();
            }
        } catch (CancellationException e) {
            cancel(false);
        } catch (Throwable t) {
    ...
    private void setSixthValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, Y, Tuple6<T, U, V, W, X, Y>>castLeft(returnValue));
                }
            } else {
                sixthValue = returnValue.right().get();
            }
        } catch (CancellationException e) {
            cancel(false);
        } catch (Throwable t) {
