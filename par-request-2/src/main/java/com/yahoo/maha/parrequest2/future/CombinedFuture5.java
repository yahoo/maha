...
class CombinedFuture5<T, U, V, W, X> extends AbstractFuture<Either<GeneralError, Tuple5<T, U, V, W, X>>> {
        ...
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, T, Tuple5<T, U, V, W, X>>castLeft(returnValue));
                }
            } else {
    ...
    private void setSecondValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, U, Tuple5<T, U, V, W, X>>castLeft(returnValue));
                }
            } else {
    ...
    private void setThirdValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, V, Tuple5<T, U, V, W, X>>castLeft(returnValue));
                }
            } else {
    ...
    private void setFourthValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, W, Tuple5<T, U, V, W, X>>castLeft(returnValue));
                }
            } else {
    ...
    private void setFifthValue() {
        try {
            ...
            if (returnValue.isLeft()) {
                if (shortCircuit.compareAndSet(false, true)) {
                    set(EitherUtils.<GeneralError, X, Tuple5<T, U, V, W, X>>castLeft(returnValue));
                }
            } else {
