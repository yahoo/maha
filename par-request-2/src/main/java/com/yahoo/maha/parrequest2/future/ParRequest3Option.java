 ...
 */
public class ParRequest3Option<T, U, V> extends CombinableRequest<Tuple3<Option<T>, Option<U>, Option<V>>> {

    private final ParallelServiceExecutor executor;
    private final CombinedFuture3Option<T, U, V> combinedFuture3;
    ...
    public <O> Either<GeneralError, O> resultMap(ParFunction<Tuple3<Option<T>, Option<U>, Option<V>>, O> fn) {
        Either<GeneralError, Tuple3<Option<T>, Option<U>, Option<V>>>
            result =
    ...
    public <O> NoopRequest<O> fold(ParFunction<GeneralError, O> errFn,
                                   ParFunction<Tuple3<Option<T>, Option<U>, Option<V>>, O> fn) {
        return new NoopRequest<O>(executor, new FoldableFuture<>(executor, combinedFuture3, fn, errFn));
    }

    public <O> ParRequest<O> map(String label,
                                 ParFunction<Tuple3<Option<T>, Option<U>, Option<V>>, Either<GeneralError, O>> fn) {
        return new ParRequest<>(label, executor, new ComposableFuture<>(executor, combinedFuture3, fn));
    }

    public <O> ParRequest<O> flatMap(String label,
                                     ParFunction<Tuple3<Option<T>, Option<U>, Option<V>>, CombinableRequest<O>> fn) {
        return new ParRequest<>(label, executor, new ComposableFutureFuture<>(executor, combinedFuture3, fn));
    }

    public Either<GeneralError, Tuple3<Option<T>, Option<U>, Option<V>>> get() {
        return executor.getEitherSafely(label, combinedFuture3);
    }

    ListenableFuture<Either<GeneralError, Tuple3<Option<T>, Option<U>, Option<V>>>> asFuture() {
    ...
    public static class Builder<A, B, C> {
        ...
        public Builder<A, B, C> allMustSucceed(boolean allMustSucceed) {
            this.allMustSucceed = allMustSucceed;
            return this;
        }

        public ParRequest3Option<A, B, C> build() {
