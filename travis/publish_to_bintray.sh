...
mvn deploy -Dscoverage.skip=true -DskipTests -Darguments="-DskipTests -Dscoverage.skip=true" --projects com.yahoo.maha:maha-core --settings travis/settings-maha-core.xml
