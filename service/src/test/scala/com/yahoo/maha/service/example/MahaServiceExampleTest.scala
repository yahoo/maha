  ...
  test("Test: 3 same level dim tables join should be succeed (student, researchers, class_volunteers)") {
    ...
    val expected =
      s"""
         ...
         |              FROM(SELECT sv1.name "Student Name", r0.name "Researcher Name", cv2.name "Class Volunteer Name"
         |                  FROM
         ...
         |
         |             ) cv2
         |              ON( sv1.class_volunteer_id = cv2.id )
         |               INNER JOIN
         |            (SELECT  name, id
         |            FROM researcher
         |
  ...
  test("Test: 3 same level dim tables join should be succeed (researchers, science_lab_volunteers, tutor)") {
    ...
    val expected =
      s"""
         ...
         |              FROM(SELECT r1.name "Researcher Name", slv2.name "Science Lab Volunteer Name", t0.name "Tutor Name"
         |                  FROM
         ...
         |
         |             ) slv2
         |              ON( r1.science_lab_volunteer_id = slv2.id )
         |               INNER JOIN
         |            (SELECT  name, id
         |            FROM tutor
         |
         |             ) t0
         |              ON( r1.tutor_id = t0.id )
         |               )
         |
         |                  ))
         |                   WHERE ROW_NUMBER >= 1 AND ROW_NUMBER <= 200
  ...
  test("Test: 4 same level dim tables join should be succeed (student, researchers, class_volunteers, science_lab_volunteers)") {
    ...
    val expected =
      s"""
         ...
         |              FROM(SELECT sv2.name "Student Name", cv3.name "Class Volunteer Name", r1.name "Researcher Name", slv0.name "Science Lab Volunteer Name"
         |                  FROM
         |               ( (SELECT  class_volunteer_id, researcher_id, name, id
         |            FROM student_v1
         |            WHERE (id = 213)
         ...
         |
         |             ) cv3
         |              ON( sv2.class_volunteer_id = cv3.id )
         |               INNER JOIN
         |            (SELECT  science_lab_volunteer_id, name, id
         |            FROM researcher
         |
  ...
  test("Testing 5 same level dim tables join") {
    ...
    val expected =
      s"""
         ...
         |              FROM(SELECT sv3.name "Student Name", r1.name "Researcher Name", cv4.name "Class Volunteer Name", slv2.name "Science Lab Volunteer Name", t0.name "Tutor Name"
         |                  FROM
         |               ( (SELECT  class_volunteer_id, researcher_id, name, id
         |            FROM student_v1
         |            WHERE (id = 213)
         ...
         |
         |             ) cv4
         |              ON( sv3.class_volunteer_id = cv4.id )
         |               INNER JOIN
         |            (SELECT  science_lab_volunteer_id, tutor_id, name, id
         |            FROM researcher
         |
         |             ) r1
         |              ON( sv3.researcher_id = r1.id )
         |               INNER JOIN
         |            (SELECT  name, id
         |            FROM science_lab_volunteer
         |
  ...
  test("Test") {
    ...
    val expected =
      s"""
         |SELECT  *
         |      FROM (
         |          SELECT "Student Name", "Researcher Name", "Class Volunteer Name", "Science Lab Volunteer Name", "Tutor Name", "Class Name", "Section Name", ROWNUM AS ROW_NUMBER
         |              FROM(SELECT sv5.name "Student Name", r3.name "Researcher Name", cv6.name "Class Volunteer Name", slv4.name "Science Lab Volunteer Name", t2.name "Tutor Name", c0.name "Class Name", s1.name "Section Name"
         |                  FROM
         ...
         |
         |             ) sv5
         |              ON( s1.student_id = sv5.id )
         |               INNER JOIN
         |            (SELECT  name, id
         |            FROM class_volunteer
         |
         |             ) cv6
         |              ON( sv5.class_volunteer_id = cv6.id )
         |               INNER JOIN
         |            (SELECT  science_lab_volunteer_id, tutor_id, name, id
         |            FROM researcher
         |
         |             ) r3
         |              ON( sv5.researcher_id = r3.id )
         |               INNER JOIN
         |            (SELECT  name, id
         |            FROM science_lab_volunteer
         |
         |             ) slv4
         |              ON( r3.science_lab_volunteer_id = slv4.id )
         |               INNER JOIN
         |            (SELECT  name, id
         |            FROM tutor
         |
         |             ) t2
         |              ON( r3.tutor_id = t2.id )
         |               INNER JOIN
         |            (SELECT  name, id
         |            FROM class
         |
