  ...
  test("test AvaticaMahaJsonHandler") {
    {
      ...
      val expected = """{"response":"error","exceptions":[],"errorMessage":"Failed to execute the Request,Test execu exception  ","errorCode":500,"sqlState":"DATA_EXCEPTION_NO_SUBCLASS","severity":"FATAL","rpcMetadata":{"response":"rpcMetadata","serverAddress":""}}"""
    ...
    }
    {
      ...
      val expected = """{"response":"error","exceptions":[],"errorMessage":"Bad SQL Request,Test execu exception,Inner exception ","errorCode":400,"sqlState":"INVALID_SQL_STATEMENT_IDENTIFIER_NO_SUBCLASS","severity":"ERROR","rpcMetadata":{"response":"rpcMetadata","serverAddress":""}}"""
      res should equal (expected) (after being whiteSpaceNormalised)
    }
    {
    ...
    }
    {
      ...
      val expected = """{"response":"error","exceptions":[],"errorMessage":"Bad SQL Request,Test execu exception, ","errorCode":400,"sqlState":"INVALID_SQL_STATEMENT_IDENTIFIER_NO_SUBCLASS","severity":"ERROR","rpcMetadata":{"response":"rpcMetadata","serverAddress":""}}"""
      res should equal (expected) (after being whiteSpaceNormalised)
    }
    {
    ...
    }
    {
      ...
      val expected = """{"response":"error","exceptions":[],"errorMessage":"Exception at executing query Test execu exception, ","errorCode":500,"sqlState":"DATA_EXCEPTION_NO_SUBCLASS","severity":"UNKNOWN","rpcMetadata":{"response":"rpcMetadata","serverAddress":""}}"""
      res should equal (expected) (after being whiteSpaceNormalised)
    }
  }
}
